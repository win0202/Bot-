...
if (args ===`오명선`){
       message.channel.send("```asciidoc\n[오명선] 6★\n종류 : 선\n능력 : 공격력 - 정신력 90 방어력 - 순발력 7 사기 -\n효과 : 책략 사용 시 소모되는 MP의 양이 20% 만큼 감소한다.```");
    }
if (args ===`사진참사검`){
       message.channel.send("```asciidoc\n[사진참사검] 6★\n종류 : 보도\n능력 : 공격력 - 정신력 86 방어력 - 순발력 - 사기 -\n효과 : 책략 사용 시 소모되는 MP의 양이 20% 만큼 감소한다.```");
    }
if (args ===`청봉보검`){
       message.channel.send("```asciidoc\n[청봉보검] 6★\n종류 : 보도\n능력 : 공격력 - 정신력 77 방어력 - 순발력 14 사기 -\n효과 : 모든 공격 책략 사용 시 책략의 위력이 3% 만큼 증가한다.```");
    }
if (args ===`거궐`){
       message.channel.send("```asciidoc\n[거궐] 6★\n종류 : 검\n능력 : 공격력 90 정신력 - 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`강요보장`){
       message.channel.send("```asciidoc\n[강요보장] 6★\n종류 : 창\n능력 : 공격력 105 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`강철수극`){
       message.channel.send("```asciidoc\n[강철수극] 6★\n종류 : 곤\n능력 : 공격력 92 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`묵언궁`){
       message.channel.send("```asciidoc\n[묵언궁] 6★\n종류 : 활\n능력 : 공격력 111 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`묵언노`){
       message.channel.send("```asciidoc\n[묵언노] 6★\n종류 : 노\n능력 : 공격력 100 정신력 5 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`선풍오포`){
       message.channel.send("```asciidoc\n[선풍오포] 6★\n종류 : 포\n능력 : 공격력 99 정신력 - 방어력 - 순발력 7 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`순구`){
       message.channel.send("```asciidoc\n[순구] 6★\n종류 : 검\n능력 : 공격력 86 정신력 - 방어력 - 순발력 7 사기 7\n효과 : 공격 시 20% 확률로 피격자에게 금책 효과를 건다.```");
    }
if (args ===`점강모`){
       message.channel.send("```asciidoc\n[점강모] 6★\n종류 : 창\n능력 : 공격력 95 정신력 - 방어력 - 순발력 7 사기 7\n효과 : 공격 시 20% 확률로 피격자에게 금책 효과를 건다.```");
    }
if (args ===`금책은곤`){
       message.channel.send("```asciidoc\n[금책은곤] 6★\n종류 : 곤\n능력 : 공격력 92 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20% 확률로 피격자에게 금책 효과를 건다.```");
    }
if (args ===`금비전`){
       message.channel.send("```asciidoc\n[금비전] 6★\n종류 : 활\n능력 : 공격력 86 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20% 확률로 피격자에게 금책 효과를 건다.```");
    }
if (args ===`수궁노`){
       message.channel.send("```asciidoc\n[수궁노] 6★\n종류 : 노\n능력 : 공격력 90 정신력 - 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20% 확률로 피격자에게 금책 효과를 건다.```");
    }
if (args ===`승사`){
       message.channel.send("```asciidoc\n[승사] 6★\n종류 : 검\n능력 : 공격력 86 정신력 7 방어력 - 순발력 7 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`개산대부`){
       message.channel.send("```asciidoc\n[개산대부] 6★\n종류 : 창\n능력 : 공격력 95 정신력 - 방어력 - 순발력 14 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`이능극`){
       message.channel.send("```asciidoc\n[이능극] 6★\n종류 : 곤\n능력 : 공격력 87 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`매화궁`){
       message.channel.send("```asciidoc\n[매화궁] 6★\n종류 : 활\n능력 : 공격력 103 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`매화노`){
       message.channel.send("```asciidoc\n[매화노] 6★\n종류 : 노\n능력 : 공격력 100 정신력 5 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`토유검`){
       message.channel.send("```asciidoc\n[토유검] 6★\n종류 : 검\n능력 : 공격력 105 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
if (args ===`중독월도`){
       message.channel.send("```asciidoc\n[중독월도] 6★\n종류 : 창\n능력 : 공격력 104 정신력 - 방어력 - 순발력 7 사기 5\n효과 : 공격 시 20%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
if (args ===`맹독극`){
       message.channel.send("```asciidoc\n[맹독극] 6★\n종류 : 곤\n능력 : 공격력 91 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
if (args ===`맹독비전`){
       message.channel.send("```asciidoc\n[맹독비전] 6★\n종류 : 활\n능력 : 공격력 111 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
...
if (args ===`어장`){
       message.channel.send("```asciidoc\n[어장] 6★\n종류 : 검\n능력 : 공격력 86 정신력 7 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20%의 확률로 피격자에게 부동 효과를 건다.```");
    }
if (args ===`복익극`){
       message.channel.send("```asciidoc\n[복익극] 6★\n종류 : 창\n능력 : 공격력 89 정신력 - 방어력 - 순발력 7 사기 14\n효과 : 공격 시 20%의 확률로 피격자에게 부동 효과를 건다.```");
    }
if (args ===`묵언추`){
       message.channel.send("```asciidoc\n[묵언추] 6★\n종류 : 곤\n능력 : 공격력 92 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 부동 효과를 건다.```");
    }
...
if (args ===`용두삼시수노`){
       message.channel.send("```asciidoc\n[용두삼시수노] 6★\n종류 : 노\n능력 : 공격력 90 정신력 - 방어력 - 순발력 7 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 부동 효과를 건다.```");
    }
if (args ===`임충`){
       message.channel.send("```asciidoc\n[임충] 6★\n종류 : 포\n능력 : 공격력 84 정신력 - 방어력 - 순발력 5 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 부동 효과를 건다.```");
    }
if (args ===`담로`){
...
if (args ===`석월장`){
       message.channel.send("```asciidoc\n[석월장] 6★\n종류 : 곤\n능력 : 공격력 81 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20% 확률로 피격자에게 무작위로 속성이상을 건다.```");
    }
if (args ===`이능궁`){
       message.channel.send("```asciidoc\n[이능궁] 6★\n종류 : 활\n능력 : 공격력 111 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20% 확률로 피격자에게 무작위로 속성이상을 건다.```");
    }
if (args ===`이능노`){
       message.channel.send("```asciidoc\n[이능노] 6★\n종류 : 노\n능력 : 공격력 100 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20% 확률로 피격자에게 무작위로 속성이상을 건다.```");
    }
if (args ===`봉황포`){
       message.channel.send("```asciidoc\n[봉황포] 6★\n종류 : 포\n능력 : 공격력 85 정신력 - 방어력 - 순발력 5 사기 -\n효과 : 공격 시 20% 확률로 피격자에게 무작위로 속성이상을 건다.```");
    }
if (args ===`우미도`){
       message.channel.send("```asciidoc\n[우미도] 6★\n종류 : 검\n능력 : 공격력 95 정신력 - 방어력 - 순발력 7 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 10% 만큼 증가한다.```");
    }
if (args ===`사모`){
       message.channel.send("```asciidoc\n[사모] 6★\n종류 : 창\n능력 : 공격력 105 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 10% 만큼 증가한다.```");
    }
if (args ===`제비추`){
       message.channel.send("```asciidoc\n[제비추] 6★\n종류 : 곤\n능력 : 공격력 86 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 10% 만큼 증가한다.```");
    }
if (args ===`수전`){
       message.channel.send("```asciidoc\n[수전] 6★\n종류 : 활\n능력 : 공격력 111 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 10% 만큼 증가한다.```");
    }
if (args ===`반혼노`){
       message.channel.send("```asciidoc\n[반혼노] 6★\n종류 : 노\n능력 : 공격력 100 정신력 - 방어력 - 순발력 - 사기 7\n효과 : 연속 공격 시 추가 공격의 위력이 10% 만큼 증가한다.```");
    }
if (args ===`동옥`){
       message.channel.send("```asciidoc\n[동옥] 6★\n종류 : 포\n능력 : 공격력 90 정신력 - 방어력 - 순발력 5 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 10% 만큼 증가한다.```");
    }
if (args ===`봉익선`){
       message.channel.send("```asciidoc\n[봉익선] 6★\n종류 : 선\n능력 : 공격력 - 정신력 95 방어력 - 순발력 - 사기 -\n효과 : 연속 책략 시 추가 책략의 위력이 증가한다.```");
    }
if (args ===`사인참사검`){
       message.channel.send("```asciidoc\n[사인참사검] 6★\n종류 : 보도\n능력 : 공격력 - 정신력 81 방어력 - 순발력 7 사기 -\n효과 : 연속 책략 시 추가 책략의 위력이 증가한다.```");
    }
if (args ===`초량선`){
       message.channel.send("```asciidoc\n[초량선] 6★\n종류 : 선\n능력 : 공격력 - 정신력 90 방어력 - 순발력 - 사기 7\n효과 : 원소(화, 수, 지, 풍) 책략 사용 시 책략의 위력이 5% 만큼 증가한다.```");
    }
if (args ===`남도`){
       message.channel.send("```asciidoc\n[남도] 6★\n종류 : 검\n능력 : 공격력 102 정신력 5 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20%의 확률로 피격자에게 중독 효과를 건다.```");
    }
if (args ===`독사부`){
       message.channel.send("```asciidoc\n[독사부] 6★\n종류 : 창\n능력 : 공격력 103 정신력 - 방어력 - 순발력 7 사기 5\n효과 : 공격 시 20%의 확률로 피격자에게 중독 효과를 건다.```");
    }
if (args ===`독사추`){
       message.channel.send("```asciidoc\n[독사추] 6★\n종류 : 곤\n능력 : 공격력 95 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 중독 효과를 건다.```");
    }
if (args ===`독사궁`){
       message.channel.send("```asciidoc\n[독사궁] 6★\n종류 : 활\n능력 : 공격력 113 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 중독 효과를 건다.```");
    }
if (args ===`독사노`){
       message.channel.send("```asciidoc\n[독사노] 6★\n종류 : 노\n능력 : 공격력 100 정신력 - 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20%의 확률로 피격자에게 중독 효과를 건다.```");
    }
...
if (args ===`대륜선`){
       message.channel.send("```asciidoc\n[대륜선] 6★\n종류 : 선\n능력 : 공격력 - 정신력 86 방어력 - 순발력 7 사기 7\n효과 : 책략의 명중률이 15% 만큼 증가한다.```");
    }
if (args ===`금강보검`){
       message.channel.send("```asciidoc\n[금강보검] 6★\n종류 : 보도\n능력 : 공격력 - 정신력 77 방어력 - 순발력 - 사기 14\n효과 : 책략의 명중률이 15% 만큼 증가한다.```");
    }
if (args ===`요도`){
       message.channel.send("```asciidoc\n[요도] 6★\n종류 : 검\n능력 : 공격력 107 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`금마삭`){
       message.channel.send("```asciidoc\n[금마삭] 6★\n종류 : 창\n능력 : 공격력 95 정신력 - 방어력 - 순발력 - 사기 14\n효과 : 공격 시 20%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`반혼봉`){
       message.channel.send("```asciidoc\n[반혼봉] 6★\n종류 : 곤\n능력 : 공격력 92 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`반혼궁`){
       message.channel.send("```asciidoc\n[반혼궁] 6★\n종류 : 활\n능력 : 공격력 107 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`질려노`){
       message.channel.send("```asciidoc\n[질려노] 6★\n종류 : 노\n능력 : 공격력 100 정신력 - 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`촉루지검`){
       message.channel.send("```asciidoc\n[촉루지검] 6★\n종류 : 보도\n능력 : 공격력 - 정신력 81 방어력 - 순발력 - 사기 7\n효과 : 공격 시 20%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`첨두목로`){
       message.channel.send("```asciidoc\n[첨두목로] 6★\n종류 : 포\n능력 : 공격력 85 정신력 - 방어력 - 순발력 5 사기 -\n효과 : 공격 시 20%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`쌍룡검`){
       message.channel.send("```asciidoc\n[쌍룡검] 6★\n종류 : 검\n능력 : 공격력 95 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 회심 공격 시 위력이 더욱 증가한다.```");
    }
if (args ===`허도부`){
       message.channel.send("```asciidoc\n[허도부] 6★\n종류 : 창\n능력 : 공격력 99 정신력 - 방어력 - 순발력 - 사기 7\n효과 : 회심 공격 시 위력이 더욱 증가한다.```");
    }
if (args ===`건곤권`){
       message.channel.send("```asciidoc\n[건곤권] 6★\n종류 : 곤\n능력 : 공격력 86 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 회심 공격 시 위력이 더욱 증가한다.```");
    }
if (args ===`작화궁`){
       message.channel.send("```asciidoc\n[작화궁] 6★\n종류 : 활\n능력 : 공격력 81 정신력 - 방어력 - 순발력 7 사기 -\n효과 : 회심 공격 시 위력이 더욱 증가한다.```");
    }
if (args ===`양유기노`){
       message.channel.send("```asciidoc\n[양유기노] 6★\n종류 : 노\n능력 : 공격력 95 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 회심 공격 시 위력이 더욱 증가한다.```");
    }
...
if (args ===`원융검`){
       message.channel.send("```asciidoc\n[원융검] 6★\n종류 : 검\n능력 : 공격력 90 정신력 7 방어력 - 순발력 - 사기 -\n효과 : 물리 공격 시 피해의 10%를 본대의 HP로 흡수한다.```");
    }
if (args ===`호룡담`){
       message.channel.send("```asciidoc\n[호룡담] 6★\n종류 : 창\n능력 : 공격력 89 정신력 - 방어력 - 순발력 14 사기 7\n효과 : 물리 공격 시 피해의 10%를 본대의 HP로 흡수한다.```");
    }
if (args ===`철질려골타`){
       message.channel.send("```asciidoc\n[철질려골타] 6★\n종류 : 곤\n능력 : 공격력 81 정신력 - 방어력 - 순발력 7 사기 -\n효과 : 물리 공격 시 피해의 10%를 본대의 HP로 흡수한다.```");
    }
if (args ===`옥선`){
       message.channel.send("```asciidoc\n[옥선] 7★\n종류 : 선\n능력 : 공격력 - 정신력 95 방어력 - 순발력 10 사기 -\n효과 : 물리 공격 시 잔여 MP의 양만큼 물리 피해량이 증가한다. 공격 후, 잔여 MP가 10%만큼 감소한다.```");
    }
if (args ===`적소검`){
       message.channel.send("```asciidoc\n[적소검] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 90 방어력 - 순발력 - 사기 -\n효과 : 물리 공격 시 잔여 MP의 양만큼 물리 피해량이 증가한다. 공격 후, 잔여 MP가 10%만큼 감소한다.```");
    }
if (args ===`차선`){
       message.channel.send("```asciidoc\n[차선] 7★\n종류 : 선\n능력 : 공격력 - 정신력 100 방어력 - 순발력 - 사기 -\n효과 : 책략 사용 시 소모되는 MP의 양이 40% 만큼 감소한다.```");
    }
if (args ===`반야보검`){
       message.channel.send("```asciidoc\n[반야보검] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 81 방어력 - 순발력 - 사기 20\n효과 : 책략 사용 시 소모되는 MP의 양이 40% 만큼 감소한다.```");
    }
if (args ===`칠성보도`){
       message.channel.send("```asciidoc\n[칠성보도] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 81 방어력 - 순발력 10 사기 10\n효과 : 적을 공격할 때 총 공격력과 총 정신력 중 더 높은 피해를 줄 수 있는 능력치로 공격한다.```");
    }
if (args ===`운광검`){
       message.channel.send("```asciidoc\n[운광검] 7★\n종류 : 검\n능력 : 공격력 80 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 범위 확장```");
    }
if (args ===`첨당파`){
       message.channel.send("```asciidoc\n[첨당파] 7★\n종류 : 창\n능력 : 공격력 98 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 범위 확장```");
    }
if (args ===`여의봉`){
       message.channel.send("```asciidoc\n[여의봉] 7★\n종류 : 곤\n능력 : 공격력 86 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 공격 범위 확장```");
    }
if (args ===`청황궁`){
       message.channel.send("```asciidoc\n[청황궁] 7★\n종류 : 활\n능력 : 공격력 102 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 범위 확장```");
    }
if (args ===`강철장극`){
       message.channel.send("```asciidoc\n[강철장극] 7★\n종류 : 곤\n능력 : 공격력 97 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`묵음궁`){
       message.channel.send("```asciidoc\n[묵음궁] 7★\n종류 : 활\n능력 : 공격력 112 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`묵음노`){
       message.channel.send("```asciidoc\n[묵음노] 7★\n종류 : 노\n능력 : 공격력 100 정신력 7 방어력 - 순발력 - 사기 10\n효과 : 공격 시 35%의 확률로 피격자에게 아이템 사용 금지 상태이상을 건다.```");
    }
if (args ===`금책금곤`){
       message.channel.send("```asciidoc\n[금책금곤] 7★\n종류 : 곤\n능력 : 공격력 97 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 공격 시 35% 확률로 피격자에게 금책 효과를 건다.```");
    }
if (args ===`금전`){
       message.channel.send("```asciidoc\n[금전] 7★\n종류 : 포\n능력 : 공격력 105 정신력 - 방어력 - 순발력 - 사기 10\n효과 : 공격 시 35% 확률로 피격자에게 금책 효과를 건다.```");
    }
if (args ===`명광검`){
       message.channel.send("```asciidoc\n[명광검] 7★\n종류 : 검\n능력 : 공격력 110 정신력 - 방어력 - 순발력 10 사기 10\n효과 : 공격 시 이동한 거리 X 3% 만큼 피격자의 공격 방어 확률을 감소시킨 후, 공격한다. 이 효과는 부대 행동이 종료될 때 초기화된다.```");
    }
if (args ===`예당파`){
       message.channel.send("```asciidoc\n[예당파] 7★\n종류 : 창\n능력 : 공격력 125 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 이동한 거리 X 3% 만큼 피격자의 공격 방어 확률을 감소시킨 후, 공격한다. 이 효과는 부대 행동이 종료될 때 초기화된다.```");
    }
if (args ===`비뢰추`){
       message.channel.send("```asciidoc\n[비뢰추] 7★\n종류 : 곤\n능력 : 공격력 105 정신력 - 방어력 10 순발력 10 사기 10\n효과 : 공격 시 이동한 거리 X 3% 만큼 피격자의 공격 방어 확률을 감소시킨 후, 공격한다. 이 효과는 부대 행동이 종료될 때 초기화된다.```");
    }
if (args ===`파천궁`){
       message.channel.send("```asciidoc\n[파천궁] 7★\n종류 : 활\n능력 : 공격력 110 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 이동한 거리 X 3% 만큼 피격자의 공격 방어 확률을 감소시킨 후, 공격한다. 이 효과는 부대 행동이 종료될 때 초기화된다.```");
    }
if (args ===`질풍노`){
       message.channel.send("```asciidoc\n[질풍노] 7★\n종류 : 노\n능력 : 공격력 90 정신력 - 방어력 10 순발력 10 사기 10\n효과 : 공격 시 이동한 거리 X 3% 만큼 피격자의 공격 방어 확률을 감소시킨 후, 공격한다. 이 효과는 부대 행동이 종료될 때 초기화된다.```");
    }
if (args ===`대완구`){
       message.channel.send("```asciidoc\n[대완구] 7★\n종류 : 포\n능력 : 공격력 95 정신력 - 방어력 - 순발력 10 사기 10\n효과 : 공격 시 이동한 거리 X 3% 만큼 피격자의 공격 방어 확률을 감소시킨 후, 공격한다. 이 효과는 부대 행동이 종료될 때 초기화된다.```");
    }
if (args ===`금교전`){
       message.channel.send("```asciidoc\n[금교전] 7★\n종류 : 검\n능력 : 공격력 90 정신력 10 방어력 - 순발력 10 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`치익월아당`){
       message.channel.send("```asciidoc\n[치익월아당] 7★\n종류 : 창\n능력 : 공격력 94 정신력 - 방어력 - 순발력 10 사기 20\n효과 : 공격 시 35%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`신능극`){
       message.channel.send("```asciidoc\n[신능극] 7★\n종류 : 곤\n능력 : 공격력 92 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`국화궁`){
       message.channel.send("```asciidoc\n[국화궁] 7★\n종류 : 활\n능력 : 공격력 104 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
if (args ===`국화노`){
       message.channel.send("```asciidoc\n[국화노] 7★\n종류 : 노\n능력 : 공격력 100 정신력 7 방어력 - 순발력 - 사기 10\n효과 : 공격 시 35%의 확률로 피격자에게 능력 감소 상태이상을 무작위로 두 가지 건다.```");
    }
...
if (args ===`류피검`){
       message.channel.send("```asciidoc\n[류피검] 7★\n종류 : 검\n능력 : 공격력 115 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
if (args ===`맹독월도`){
       message.channel.send("```asciidoc\n[맹독월도] 7★\n종류 : 창\n능력 : 공격력 114 정신력 - 방어력 - 순발력 14 사기 10\n효과 : 공격 시 35%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
if (args ===`독살극`){
       message.channel.send("```asciidoc\n[독살극] 7★\n종류 : 곤\n능력 : 공격력 96 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
if (args ===`독살비전`){
       message.channel.send("```asciidoc\n[독살비전] 7★\n종류 : 활\n능력 : 공격력 112 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
...
if (args ===`반고번`){
       message.channel.send("```asciidoc\n[반고번] 7★\n종류 : 포\n능력 : 공격력 105 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 맹독 효과를 건다.```");
    }
if (args ===`예도`){
       message.channel.send("```asciidoc\n[예도] 7★\n종류 : 검\n능력 : 공격력 90 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 적군의 반격을 무조건 회피한다.```");
    }
if (args ===`청룡언월도`){
       message.channel.send("```asciidoc\n[청룡언월도] 7★\n종류 : 창\n능력 : 공격력 110 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 적군의 반격을 무조건 회피한다.```");
    }
if (args ===`반고부`){
       message.channel.send("```asciidoc\n[반고부] 7★\n종류 : 곤\n능력 : 공격력 86 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 적군의 반격을 무조건 회피한다.```");
    }
if (args ===`현무궁`){
       message.channel.send("```asciidoc\n[현무궁] 7★\n종류 : 활\n능력 : 공격력 105 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 적군의 반격을 무조건 회피한다.```");
    }
...
if (args ===`대루`){
       message.channel.send("```asciidoc\n[대루] 7★\n종류 : 포\n능력 : 공격력 86 정신력 - 방어력 - 순발력 15 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 부동 효과를 건다.```");
    }
if (args ===`신능궁`){
       message.channel.send("```asciidoc\n[신능궁] 7★\n종류 : 활\n능력 : 공격력 112 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 35% 확률로 피격자에게 무작위로 속성이상을 건다.```");
    }
if (args ===`신능노`){
       message.channel.send("```asciidoc\n[신능노] 7★\n종류 : 노\n능력 : 공격력 100 정신력 - 방어력 - 순발력 - 사기 10\n효과 : 공격 시 35% 확률로 피격자에게 무작위로 속성이상을 건다.```");
    }
if (args ===`용준포`){
       message.channel.send("```asciidoc\n[용준포] 7★\n종류 : 포\n능력 : 공격력 87 정신력 - 방어력 - 순발력 15 사기 -\n효과 : 공격 시 35% 확률로 피격자에게 무작위로 속성이상을 건다.```");
    }
if (args ===`초천검`){
       message.channel.send("```asciidoc\n[초천검] 7★\n종류 : 검\n능력 : 공격력 100 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 범위 내의 적군이 본대를 공격할 때, 먼저 공격을 가한다. 단, '협공, 인도 공격, 파진 공격, 분전 공격' 시 발동하지 않는다.```");
    }
if (args ===`대협도`){
       message.channel.send("```asciidoc\n[대협도] 7★\n종류 : 창\n능력 : 공격력 101 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 범위 내의 적군이 본대를 공격할 때, 먼저 공격을 가한다. 단, '협공, 인도 공격, 파진 공격, 분전 공격' 시 발동하지 않는다.```");
    }
if (args ===`주작곤`){
       message.channel.send("```asciidoc\n[주작곤] 7★\n종류 : 곤\n능력 : 공격력 83 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 범위 내의 적군이 본대를 공격할 때, 먼저 공격을 가한다. 단, '협공, 인도 공격, 파진 공격, 분전 공격' 시 발동하지 않는다.```");
    }
if (args ===`동호비궁`){
       message.channel.send("```asciidoc\n[동호비궁] 7★\n종류 : 활\n능력 : 공격력 86 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 범위 내의 적군이 본대를 공격할 때, 먼저 공격을 가한다. 단, '협공, 인도 공격, 파진 공격, 분전 공격' 시 발동하지 않는다.```");
    }
...
if (args ===`운제포`){
       message.channel.send("```asciidoc\n[운제포] 7★\n종류 : 포\n능력 : 공격력 80 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 범위 내의 적군이 본대를 공격할 때, 먼저 공격을 가한다. 단, '협공, 인도 공격, 파진 공격, 분전 공격' 시 발동하지 않는다.```");
    }
if (args ===`안모도`){
       message.channel.send("```asciidoc\n[안모도] 7★\n종류 : 검\n능력 : 공격력 100 정신력 - 방어력 - 순발력 7 사기 5\n효과 : 연속 공격 시 추가 공격의 위력이 20% 만큼 증가한다.```");
    }
if (args ===`금정개산월`){
       message.channel.send("```asciidoc\n[금정개산월] 7★\n종류 : 창\n능력 : 공격력 110 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 20% 만큼 증가한다.```");
    }
if (args ===`수리추`){
       message.channel.send("```asciidoc\n[수리추] 7★\n종류 : 곤\n능력 : 공격력 91 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 20% 만큼 증가한다.```");
    }
if (args ===`매화수전`){
       message.channel.send("```asciidoc\n[매화수전] 7★\n종류 : 활\n능력 : 공격력 112 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 20% 만큼 증가한다.```");
    }
if (args ===`만혼노`){
       message.channel.send("```asciidoc\n[만혼노] 7★\n종류 : 노\n능력 : 공격력 100 정신력 - 방어력 - 순발력 7 사기 10\n효과 : 연속 공격 시 추가 공격의 위력이 20% 만큼 증가한다.```");
    }
if (args ===`동자`){
       message.channel.send("```asciidoc\n[동자] 7★\n종류 : 포\n능력 : 공격력 90 정신력 - 방어력 - 순발력 15 사기 -\n효과 : 연속 공격 시 추가 공격의 위력이 20% 만큼 증가한다.```");
    }
if (args ===`참사검`){
       message.channel.send("```asciidoc\n[참사검] 7★\n종류 : 검\n능력 : 공격력 95 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 적에게 무조건 연속 반격을 가한다.```");
    }
if (args ===`주작부`){
       message.channel.send("```asciidoc\n[주작부] 7★\n종류 : 창\n능력 : 공격력 103 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 적에게 무조건 연속 반격을 가한다.```");
    }
...
if (args ===`주작궁`){
       message.channel.send("```asciidoc\n[주작궁] 7★\n종류 : 활\n능력 : 공격력 115 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 적에게 무조건 연속 반격을 가한다.```");
    }
if (args ===`주작노`){
       message.channel.send("```asciidoc\n[주작노] 7★\n종류 : 노\n능력 : 공격력 95 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 적에게 무조건 연속 반격을 가한다.```");
    }
if (args ===`현자총통`){
       message.channel.send("```asciidoc\n[현자총통] 7★\n종류 : 포\n능력 : 공격력 85 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 적에게 무조건 연속 반격을 가한다.```");
    }
if (args ===`백학선`){
       message.channel.send("```asciidoc\n[백학선] 7★\n종류 : 선\n능력 : 공격력 - 정신력 95 방어력 - 순발력 - 사기 10\n효과 : 공격 책략 사용 시 연속으로 책략을 사용한다.```");
    }
if (args ===`무귀보도`){
       message.channel.send("```asciidoc\n[무귀보도] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 86 방어력 - 순발력 10 사기 -\n효과 : 공격 책략 사용 시 연속으로 책략을 사용한다.```");
    }
if (args ===`백련검`){
       message.channel.send("```asciidoc\n[백련검] 7★\n종류 : 검\n능력 : 공격력 96 정신력 - 방어력 - 순발력 10 사기 10\n효과 : 공격과 반격 시 무조건 연속 공격을 가한다.```");
    }
if (args ===`초진창`){
       message.channel.send("```asciidoc\n[초진창] 7★\n종류 : 창\n능력 : 공격력 99 정신력 - 방어력 - 순발력 20 사기 -\n효과 : 공격과 반격 시 무조건 연속 공격을 가한다.```");
    }
if (args ===`청룡곤`){
       message.channel.send("```asciidoc\n[청룡곤] 7★\n종류 : 곤\n능력 : 공격력 81 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격과 반격 시 무조건 연속 공격을 가한다.```");
    }
if (args ===`청룡궁`){
       message.channel.send("```asciidoc\n[청룡궁] 7★\n종류 : 활\n능력 : 공격력 110 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격과 반격 시 무조건 연속 공격을 가한다.```");
    }
...
if (args ===`황자총통`){
       message.channel.send("```asciidoc\n[황자총통] 7★\n종류 : 포\n능력 : 공격력 70 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격과 반격 시 무조건 연속 공격을 가한다.```");
    }
if (args ===`천유검`){
       message.channel.send("```asciidoc\n[천유검] 7★\n종류 : 검\n능력 : 공격력 97 정신력 - 방어력 - 순발력 15 사기 -\n효과 : 공격 시 적을 퇴각시키면 공격 범위 내의 다른 부대를 추가로 공격한다. 단, 아군 차례에만 발동한다.```");
    }
if (args ===`애각창`){
       message.channel.send("```asciidoc\n[애각창] 7★\n종류 : 창\n능력 : 공격력 99 정신력 - 방어력 - 순발력 10 사기 10\n효과 : 공격 시 적을 퇴각시키면 공격 범위 내의 다른 부대를 추가로 공격한다. 단, 아군 차례에만 발동한다.```");
    }
if (args ===`음양곤`){
       message.channel.send("```asciidoc\n[음양곤] 7★\n종류 : 곤\n능력 : 공격력 86 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 적을 퇴각시키면 공격 범위 내의 다른 부대를 추가로 공격한다. 단, 아군 차례에만 발동한다.```");
    }
if (args ===`음양궁`){
       message.channel.send("```asciidoc\n[음양궁] 7★\n종류 : 활\n능력 : 공격력 109 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 적을 퇴각시키면 공격 범위 내의 다른 부대를 추가로 공격한다. 단, 아군 차례에만 발동한다.```");
    }
if (args ===`음양노`){
       message.channel.send("```asciidoc\n[음양노] 7★\n종류 : 노\n능력 : 공격력 95 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 적을 퇴각시키면 공격 범위 내의 다른 부대를 추가로 공격한다. 단, 아군 차례에만 발동한다.```");
    }
if (args ===`신위검`){
       message.channel.send("```asciidoc\n[신위검] 7★\n종류 : 검\n능력 : 공격력 120 정신력 - 방어력 - 순발력 7 사기 -\n효과 : 공격 시 50% 만큼 추가 피해를 준다. 단, 연속 공격과 연속 반격이 발동하지 않는다.```");
    }
if (args ===`황룡언월도`){
       message.channel.send("```asciidoc\n[황룡언월도] 7★\n종류 : 창\n능력 : 공격력 125 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 50% 만큼 추가 피해를 준다. 단, 연속 공격과 연속 반격이 발동하지 않는다.```");
    }
if (args ===`금강대부`){
       message.channel.send("```asciidoc\n[금강대부] 7★\n종류 : 곤\n능력 : 공격력 115 정신력 - 방어력 7 순발력 7 사기 -\n효과 : 공격 시 50% 만큼 추가 피해를 준다. 단, 연속 공격과 연속 반격이 발동하지 않는다.```");
    }
if (args ===`벽력궁`){
       message.channel.send("```asciidoc\n[벽력궁] 7★\n종류 : 활\n능력 : 공격력 115 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 50% 만큼 추가 피해를 준다. 단, 연속 공격과 연속 반격이 발동하지 않는다.```");
    }
if (args ===`수질노`){
       message.channel.send("```asciidoc\n[수질노] 7★\n종류 : 노\n능력 : 공격력 110 정신력 - 방어력 - 순발력 - 사기 7\n효과 : 공격 시 50% 만큼 추가 피해를 준다. 단, 연속 공격과 연속 반격이 발동하지 않는다.```");
    }
if (args ===`지자총통`){
       message.channel.send("```asciidoc\n[지자총통] 7★\n종류 : 포\n능력 : 공격력 105 정신력 - 방어력 - 순발력 7 사기 7\n효과 : 공격 시 50% 만큼 추가 피해를 준다. 단, 연속 공격과 연속 반격이 발동하지 않는다.```");
    }
if (args ===`자웅일대검`){
       message.channel.send("```asciidoc\n[자웅일대검] 7★\n종류 : 검\n능력 : 공격력 85 정신력 10 방어력 - 순발력 10 사기 10\n효과 : 적군의 반격에 맞서 반격할 수 있다. (반격 시 공격력은 기본 공격력의 0.75배)```");
    }
if (args ===`청룡부`){
       message.channel.send("```asciidoc\n[청룡부] 7★\n종류 : 창\n능력 : 공격력 99 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 적군의 반격에 맞서 반격할 수 있다. (반격 시 공격력은 기본 공격력의 0.75배)```");
    }
if (args ===`쌍편`){
       message.channel.send("```asciidoc\n[쌍편] 7★\n종류 : 곤\n능력 : 공격력 81 정신력 10 방어력 - 순발력 10 사기 -\n효과 : 적군의 반격에 맞서 반격할 수 있다. (반격 시 공격력은 기본 공격력의 0.75배)```");
    }
if (args ===`활영궁`){
       message.channel.send("```asciidoc\n[활영궁] 7★\n종류 : 활\n능력 : 공격력 90 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 적군의 반격에 맞서 반격할 수 있다. (반격 시 공격력은 기본 공격력의 0.75배)```");
    }
...
if (args ===`백호부`){
       message.channel.send("```asciidoc\n[백호부] 7★\n종류 : 창\n능력 : 공격력 91 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 무조건 연속 공격을 가한다.```");
    }
if (args ===`백호곤`){
       message.channel.send("```asciidoc\n[백호곤] 7★\n종류 : 곤\n능력 : 공격력 87 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 무조건 연속 공격을 가한다.```");
    }
if (args ===`백호궁`){
       message.channel.send("```asciidoc\n[백호궁] 7★\n종류 : 활\n능력 : 공격력 105 정신력 - 방어력 - 순발력 - 사기 -\n효과 : 공격 시 무조건 연속 공격을 가한다.```");
    }
...
if (args ===`북도`){
       message.channel.send("```asciidoc\n[북도] 7★\n종류 : 검\n능력 : 공격력 112 정신력 10 방어력 - 순발력 - 사기 10\n효과 : 공격 시 35%의 확률로 피격자에게 중독 효과를 건다.```");
    }
if (args ===`독룡부`){
       message.channel.send("```asciidoc\n[독룡부] 7★\n종류 : 창\n능력 : 공격력 113 정신력 - 방어력 - 순발력 14 사기 10\n효과 : 공격 시 35%의 확률로 피격자에게 중독 효과를 건다.```");
    }
if (args ===`독룡추`){
       message.channel.send("```asciidoc\n[독룡추] 7★\n종류 : 곤\n능력 : 공격력 100 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 중독 효과를 건다.```");
    }
if (args ===`독룡궁`){
       message.channel.send("```asciidoc\n[독룡궁] 7★\n종류 : 활\n능력 : 공격력 114 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 중독 효과를 건다.```");
    }
if (args ===`독룡노`){
       message.channel.send("```asciidoc\n[독룡노] 7★\n종류 : 노\n능력 : 공격력 100 정신력 - 방어력 - 순발력 7 사기 10\n효과 : 공격 시 35%의 확률로 피격자에게 중독 효과를 건다.```");
    }
...
if (args ===`설화보도`){
       message.channel.send("```asciidoc\n[설화보도] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 90 방어력 7 순발력 7 사기 7\n효과 : 책략 사용 시 15% 만큼 피격자의 책략 방어 확률을 감소시킨 후, 책략을 사용한다.```");
    }
if (args ===`삼황보도`){
       message.channel.send("```asciidoc\n[삼황보도] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 86 방어력 - 순발력 - 사기 10\n효과 : 지형과 무관하게 책략을 사용할 수 있다.```");
    }
if (args ===`상장검`){
       message.channel.send("```asciidoc\n[상장검] 7★\n종류 : 검\n능력 : 공격력 98 정신력 - 방어력 - 순발력 10 사기 10\n효과 : 공격 시 적을 퇴각시키면, 이동해 공격 가능한 범위 내의 다른 부대를 추가로 공격한다. 단, 아군 차례에만 발동한다.```");
    }
if (args ===`화첨창`){
       message.channel.send("```asciidoc\n[화첨창] 7★\n종류 : 창\n능력 : 공격력 99 정신력 - 방어력 - 순발력 - 사기 20\n효과 : 공격 시 적을 퇴각시키면, 이동해 공격 가능한 범위 내의 다른 부대를 추가로 공격한다. 단, 아군 차례에만 발동한다.```");
    }
if (args ===`현무곤`){
       message.channel.send("```asciidoc\n[현무곤] 7★\n종류 : 곤\n능력 : 공격력 84 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 적을 퇴각시키면, 이동해 공격 가능한 범위 내의 다른 부대를 추가로 공격한다. 단, 아군 차례에만 발동한다.```");
    }
if (args ===`헌원검`){
       message.channel.send("```asciidoc\n[헌원검] 7★\n종류 : 검\n능력 : 공격력 95 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 피해 범위 확장 (2격)```");
    }
if (args ===`장팔사모`){
       message.channel.send("```asciidoc\n[장팔사모] 7★\n종류 : 창\n능력 : 공격력 105 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 피해 범위 확장 (2격)```");
    }
...
if (args ===`마도`){
       message.channel.send("```asciidoc\n[마도] 7★\n종류 : 검\n능력 : 공격력 112 정신력 10 방어력 - 순발력 5 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`만혼봉`){
       message.channel.send("```asciidoc\n[만혼봉] 7★\n종류 : 곤\n능력 : 공격력 97 정신력 10 방어력 - 순발력 - 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`만혼궁`){
       message.channel.send("```asciidoc\n[만혼궁] 7★\n종류 : 활\n능력 : 공격력 108 정신력 - 방어력 - 순발력 10 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`능각노`){
       message.channel.send("```asciidoc\n[능각노] 7★\n종류 : 노\n능력 : 공격력 100 정신력 - 방어력 - 순발력 7 사기 10\n효과 : 공격 시 35%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`사신보도`){
       message.channel.send("```asciidoc\n[사신보도] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 81 방어력 - 순발력 20 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`첨두석로`){
       message.channel.send("```asciidoc\n[첨두석로] 7★\n종류 : 포\n능력 : 공격력 87 정신력 - 방어력 - 순발력 15 사기 -\n효과 : 공격 시 35%의 확률로 피격자에게 혼란 효과를 건다.```");
    }
if (args ===`구리가라검`){
       message.channel.send("```asciidoc\n[구리가라검] 7★\n종류 : 검\n능력 : 공격력 90 정신력 - 방어력 - 순발력 10 사기 10\n효과 : 회심 공격 시 위력이 더욱 증가한다.```");
    }
if (args ===`어골창`){
       message.channel.send("```asciidoc\n[어골창] 7★\n종류 : 창\n능력 : 공격력 105 정신력 - 방어력 - 순발력 - 사기 10\n효과 : 회심 공격 시 위력이 더욱 증가한다.```");
    }
if (args ===`파산검`){
       message.channel.send("```asciidoc\n[파산검] 7★\n종류 : 검\n능력 : 공격력 90 정신력 10 방어력 - 순발력 - 사기 10\n효과 : 물리 공격 시 피해의 20%를 본대의 HP로 흡수한다.```");
    }
if (args ===`혼천절`){
       message.channel.send("```asciidoc\n[혼천절] 7★\n종류 : 창\n능력 : 공격력 94 정신력 - 방어력 - 순발력 20 사기 10\n효과 : 물리 공격 시 피해의 20%를 본대의 HP로 흡수한다.```");
    }
if (args ===`양황갑`){
       message.channel.send("```asciidoc\n[양황갑] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 105 순발력 - 사기 7\n효과 : 최대 HP가 100 만큼 증가한다.```");
    }
if (args ===`백룡문의`){
       message.channel.send("```asciidoc\n[백룡문의] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 7 방어력 65 순발력 - 사기 -\n효과 : 최대 HP가 100 만큼 증가한다.```");
    }
if (args ===`백화전포`){
       message.channel.send("```asciidoc\n[백화전포] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 72 순발력 3 사기 5\n효과 : 최대 HP가 100 만큼 증가한다.```");
    }
if (args ===`동미늘갑`){
       message.channel.send("```asciidoc\n[동미늘갑] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 85 순발력 7 사기 12\n효과 : 매 턴 최대 HP의 10% 만큼 HP가 회복된다.```");
    }
if (args ===`동철금의`){
       message.channel.send("```asciidoc\n[동철금의] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 5 방어력 65 순발력 10 사기 -\n효과 : 매 턴 최대 HP의 10% 만큼 HP가 회복된다.```");
    }
if (args ===`맹호전포`){
       message.channel.send("```asciidoc\n[맹호전포] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 75 순발력 3 사기 5\n효과 : 매 턴 최대 HP의 10% 만큼 HP가 회복된다.```");
    }
if (args ===`정백갑`){
       message.channel.send("```asciidoc\n[정백갑] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 100 순발력 5 사기 -\n효과 : 최대 MP가 10% 만큼 증가한다.```");
    }
if (args ===`황룡문의`){
       message.channel.send("```asciidoc\n[황룡문의] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 5 방어력 64 순발력 - 사기 -\n효과 : 최대 MP가 10% 만큼 증가한다.```");
    }
if (args ===`청룡전포`){
       message.channel.send("```asciidoc\n[청룡전포] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 73 순발력 3 사기 5\n효과 : 최대 MP가 10% 만큼 증가한다.```");
    }
if (args ===`명광개`){
       message.channel.send("```asciidoc\n[명광개] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 86 순발력 - 사기 14\n효과 : 원거리 공격으로 입는 피해가 20% 만큼 감소한다.```");
    }
if (args ===`중치막`){
       message.channel.send("```asciidoc\n[중치막] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 63 순발력 - 사기 7\n효과 : 원거리 공격으로 입는 피해가 30% 만큼 감소한다.```");
    }
if (args ===`낙복`){
       message.channel.send("```asciidoc\n[낙복] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 76 순발력 - 사기 -\n효과 : 원거리 공격으로 입는 피해가 30% 만큼 감소한다.```");
    }
if (args ===`철갑주`){
       message.channel.send("```asciidoc\n[철갑주] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 7 사기 -\n효과 : 물리 공격을 방어할 확률이 15% 만큼 증가한다.```");
    }
if (args ===`봉황문의`){
       message.channel.send("```asciidoc\n[봉황문의] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 66 순발력 7 사기 -\n효과 : 물리 공격을 방어할 확률이 15% 만큼 증가한다.```");
    }
if (args ===`질손`){
       message.channel.send("```asciidoc\n[질손] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 72 순발력 - 사기 7\n효과 : 물리 공격을 방어할 확률이 20% 만큼 증가한다.```");
    }
if (args ===`양당갑`){
       message.channel.send("```asciidoc\n[양당갑] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 86 순발력 14 사기 -\n효과 : 물리 공격으로 입는 피해가 20% 만큼 감소한다.```");
    }
if (args ===`구장복`){
       message.channel.send("```asciidoc\n[구장복] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 63 순발력 7 사기 -\n효과 : 물리 공격으로 입는 피해가 30% 만큼 감소한다.```");
    }
if (args ===`낙구`){
       message.channel.send("```asciidoc\n[낙구] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 72 순발력 7 사기 -\n효과 : 물리 공격으로 입는 피해가 30% 만큼 감소한다.```");
    }
if (args ===`사사을갑주`){
       message.channel.send("```asciidoc\n[사사을갑주] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 95 순발력 - 사기 -\n효과 : 물리 공격 피격 시 피해의 10%를 공격자에게 되돌린다.```");
    }
if (args ===`심의`){
       message.channel.send("```asciidoc\n[심의] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 60 순발력 7 사기 7\n효과 : 물리 공격 피격 시 피해의 10%를 공격자에게 되돌린다.```");
    }
if (args ===`허저족의`){
       message.channel.send("```asciidoc\n[허저족의] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 76 순발력 - 사기 -\n효과 : 물리 공격 피격 시 피해의 10%를 공격자에게 되돌린다.```");
    }
if (args ===`양백갑`){
       message.channel.send("```asciidoc\n[양백갑] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 7 사기 7\n효과 : 순발력이 10% 만큼 증가한다.```");
    }
if (args ===`적의청리`){
       message.channel.send("```asciidoc\n[적의청리] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 5 방어력 61 순발력 - 사기 -\n효과 : 순발력이 10% 만큼 증가한다.```");
    }
if (args ===`제비전포`){
       message.channel.send("```asciidoc\n[제비전포] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 71 순발력 3 사기 5\n효과 : 순발력이 10% 만큼 증가한다.```");
    }
if (args ===`은흉갑`){
       message.channel.send("```asciidoc\n[은흉갑] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 12 사기 -\n효과 : 물리 공격과 해로운 책략을 방어할 확률이 10% 만큼 증가한다.```");
    }
if (args ===`삼각문의`){
       message.channel.send("```asciidoc\n[삼각문의] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 5 방어력 63 순발력 - 사기 -\n효과 : 물리 공격과 해로운 책략을 방어할 확률이 10% 만큼 증가한다.```");
    }
if (args ===`수우피전포`){
       message.channel.send("```asciidoc\n[수우피전포] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 72 순발력 7 사기 -\n효과 : 물리 공격과 해로운 책략을 방어할 확률이 10% 만큼 증가한다.```");
    }
if (args ===`동피갑주`){
       message.channel.send("```asciidoc\n[동피갑주] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 85 순발력 15 사기 -\n효과 : 해로운 책략을 방어할 확률이 20% 만큼 증가한다.```");
    }
if (args ===`적초의`){
       message.channel.send("```asciidoc\n[적초의] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 5 방어력 64 순발력 - 사기 -\n효과 : 해로운 책략을 방어할 확률이 20% 만큼 증가한다.```");
    }
if (args ===`서우피전포`){
       message.channel.send("```asciidoc\n[서우피전포] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 69 순발력 - 사기 14\n효과 : 해로운 책략을 방어할 확률이 20% 만큼 증가한다.```");
    }
if (args ===`유엽갑`){
       message.channel.send("```asciidoc\n[유엽갑] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 - 사기 7\n효과 : 모든 책략에 대한 피해가 20% 만큼 감소한다. 단, 사신 책략은 피해 감소하지 않음.```");
    }
if (args ===`금관조복`){
       message.channel.send("```asciidoc\n[금관조복] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 67 순발력 - 사기 -\n효과 : 모든 책략에 대한 피해가 30% 만큼 감소한다. 단, 사신 책략은 피해 감소하지 않음.```");
    }
if (args ===`운포금의`){
       message.channel.send("```asciidoc\n[운포금의] 6★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 69 순발력 14 사기 -\n효과 : 모든 책략에 대한 피해가 30% 만큼 감소한다. 단, 사신 책략은 피해 감소하지 않음.```");
    }
if (args ===`증장천갑`){
       message.channel.send("```asciidoc\n[증장천갑] 6★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 86 순발력 7 사기 7\n효과 : 책략 피격 시 피해의 10%를 공격자에게 되돌린다. 단, 사신 책략은 피해 반사하지 않음.```");
    }
if (args ===`원문호복`){
       message.channel.send("```asciidoc\n[원문호복] 6★\n종류 : 도포\n능력 : 공격력 - 정신력 5 방어력 63 순발력 - 사기 -\n효과 : 책략 피격 시 피해의 10%를 공격자에게 되돌린다. 단, 사신 책략은 피해 반사하지 않음.```");
    }
...
if (args ===`정황갑`){
       message.channel.send("```asciidoc\n[정황갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 110 순발력 12 사기 7\n효과 : 최대 HP가 150 만큼 증가한다.```");
    }
if (args ===`흑룡문의`){
       message.channel.send("```asciidoc\n[흑룡문의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 7 방어력 70 순발력 - 사기 10\n효과 : 최대 HP가 150 만큼 증가한다.```");
    }
if (args ===`매화전포`){
       message.channel.send("```asciidoc\n[매화전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 76 순발력 7 사기 10\n효과 : 최대 HP가 150 만큼 증가한다.```");
    }
if (args ===`철미늘갑`){
       message.channel.send("```asciidoc\n[철미늘갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 12 사기 -\n효과 : 매 턴 최대 HP의 15% 만큼 HP가 회복된다.```");
    }
if (args ===`은철금의`){
       message.channel.send("```asciidoc\n[은철금의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 7 방어력 68 순발력 10 사기 10\n효과 : 매 턴 최대 HP의 15% 만큼 HP가 회복된다.```");
    }
if (args ===`백호전포`){
       message.channel.send("```asciidoc\n[백호전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 79 순발력 7 사기 10\n효과 : 매 턴 최대 HP의 15% 만큼 HP가 회복된다.```");
    }
if (args ===`두석린갑옷`){
       message.channel.send("```asciidoc\n[두석린갑옷] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 100 순발력 - 사기 -\n효과 : 물리 피격 시 HP 대신 MP를 소모한다. MP가 0이 되면 HP가 소모된다.```");
    }
if (args ===`은경의`){
       message.channel.send("```asciidoc\n[은경의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 7 방어력 61 순발력 - 사기 -\n효과 : 물리 피격 시 HP 대신 MP를 소모한다. MP가 0이 되면 HP가 소모된다.```");
    }
if (args ===`백룡전포`){
       message.channel.send("```asciidoc\n[백룡전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 75 순발력 7 사기 7\n효과 : 물리 피격 시 HP 대신 MP를 소모한다. MP가 0이 되면 HP가 소모된다.```");
    }
if (args ===`정홍갑`){
       message.channel.send("```asciidoc\n[정홍갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 105 순발력 12 사기 5\n효과 : 최대 MP가 15% 만큼 증가한다.```");
    }
if (args ===`적룡문의`){
       message.channel.send("```asciidoc\n[적룡문의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 7 방어력 67 순발력 - 사기 10\n효과 : 최대 MP가 15% 만큼 증가한다.```");
    }
if (args ===`황룡전포`){
       message.channel.send("```asciidoc\n[황룡전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 77 순발력 7 사기 10\n효과 : 최대 MP가 15% 만큼 증가한다.```");
    }
if (args ===`경반갑`){
       message.channel.send("```asciidoc\n[경반갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 - 사기 20\n효과 : 원거리 공격으로 입는 피해가 35% 만큼 감소한다.```");
    }
if (args ===`비룡문의`){
       message.channel.send("```asciidoc\n[비룡문의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 71 순발력 10 사기 10\n효과 : 물리 공격을 방어할 확률이 20% 만큼 증가한다.```");
    }
if (args ===`수면탄두연환개`){
       message.channel.send("```asciidoc\n[수면탄두연환개] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 10 사기 10\n효과 : 물리 공격으로 입는 피해가 35% 만큼 감소한다.```");
    }
if (args ===`서촉홍금백화`){
       message.channel.send("```asciidoc\n[서촉홍금백화] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 72 순발력 20 사기 -\n효과 : 물리 공격 피격 시 피해의 20%를 공격자에게 되돌린다.```");
    }
if (args ===`유승금루옥의`){
       message.channel.send("```asciidoc\n[유승금루옥의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 67 순발력 10 사기 -\n효과 : 적에게 공격당할 때 총 방어력과 총 정신력 중 피해를 줄일 수 있는 능력치로 방어한다.```");
    }
if (args ===`금칠도철갑`){
       message.channel.send("```asciidoc\n[금칠도철갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 12 사기 -\n효과 : 상태이상 부동을 100% 방어한다.```");
    }
if (args ===`사각회선문의`){
       message.channel.send("```asciidoc\n[사각회선문의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 68 순발력 - 사기 10\n효과 : 상태이상 부동을 100% 방어한다.```");
    }
if (args ===`천금구`){
       message.channel.send("```asciidoc\n[천금구] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 72 순발력 - 사기 20\n효과 : 상태이상 부동을 100% 방어한다.```");
    }
if (args ===`종장철판갑`){
       message.channel.send("```asciidoc\n[종장철판갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 80 순발력 12 사기 12\n효과 : 적군의 공격에 상태이상 효과가 있을 시, 피해 없이 그 효과를 적군에게 되돌린다.```");
    }
if (args ===`청라의`){
       message.channel.send("```asciidoc\n[청라의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 70 순발력 - 사기 -\n효과 : 적군의 공격에 상태이상 효과가 있을 시, 피해 없이 그 효과를 적군에게 되돌린다.```");
    }
if (args ===`주작전포`){
       message.channel.send("```asciidoc\n[주작전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 77 순발력 10 사기 -\n효과 : 적군의 공격에 상태이상 효과가 있을 시, 피해 없이 그 효과를 적군에게 되돌린다.```");
    }
if (args ===`정람갑`){
       message.channel.send("```asciidoc\n[정람갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 95 순발력 7 사기 -\n효과 : 순발력이 15% 만큼 증가한다.```");
    }
if (args ===`녹의황리`){
       message.channel.send("```asciidoc\n[녹의황리] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 7 방어력 68 순발력 - 사기 10\n효과 : 순발력이 15% 만큼 증가한다.```");
    }
if (args ===`수리전포`){
       message.channel.send("```asciidoc\n[수리전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 74 순발력 7 사기 10\n효과 : 순발력이 15% 만큼 증가한다.```");
    }
if (args ===`청동쇄자갑`){
       message.channel.send("```asciidoc\n[청동쇄자갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 5 사기 12\n효과 : 적군의 연속 공격을 100% 방어한다. 단, '협공, 재반격, 인도 공격, 파진 공격, 분전 공격, 지원 공격' 시 발동하지 않는다.```");
    }
if (args ===`직거소사선의`){
       message.channel.send("```asciidoc\n[직거소사선의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 67 순발력 - 사기 10\n효과 : 적군의 연속 공격을 100% 방어한다. 단, '협공, 재반격, 인도 공격, 파진 공격, 분전 공격, 지원 공격' 시 발동하지 않는다.```");
    }
if (args ===`백금란의`){
       message.channel.send("```asciidoc\n[백금란의] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 76 순발력 - 사기 10\n효과 : 적군의 연속 공격을 100% 방어한다. 단, '협공, 재반격, 인도 공격, 파진 공격, 분전 공격, 지원 공격' 시 발동하지 않는다.```");
    }
if (args ===`칠단단갑`){
       message.channel.send("```asciidoc\n[칠단단갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 85 순발력 5 사기 12\n효과 : 적군의 연속 책략을 100% 방어한다.```");
    }
if (args ===`한복`){
       message.channel.send("```asciidoc\n[한복] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 68 순발력 - 사기 10\n효과 : 적군의 연속 책략을 100% 방어한다.```");
    }
if (args ===`자색힐문금의`){
       message.channel.send("```asciidoc\n[자색힐문금의] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 76 순발력 10 사기 -\n효과 : 적군의 연속 책략을 100% 방어한다.```");
    }
if (args ===`백호갑`){
       message.channel.send("```asciidoc\n[백호갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 7 방어력 115 순발력 - 사기 7\n효과 : MP가 1 이상인 경우, 정신력이 20% 증가하며, 물리 피격 시 HP 대신 MP를 모두 소모한다. 단, MP가 0일 경우에는 정신력이 20% 감소하고, 물리 피격 시 HP를 소모한다.```");
    }
if (args ===`백련문의`){
       message.channel.send("```asciidoc\n[백련문의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 15 방어력 75 순발력 - 사기 -\n효과 : MP가 1 이상인 경우, 정신력이 20% 증가하며, 물리 피격 시 HP 대신 MP를 모두 소모한다. 단, MP가 0일 경우에는 정신력이 20% 감소하고, 물리 피격 시 HP를 소모한다.```");
    }
if (args ===`기린전포`){
       message.channel.send("```asciidoc\n[기린전포] 7★\n종류 : 전포\n능력 : 공격력 7 정신력 - 방어력 80 순발력 7 사기 -\n효과 : MP가 1 이상인 경우, 정신력이 20% 증가하며, 물리 피격 시 HP 대신 MP를 모두 소모한다. 단, MP가 0일 경우에는 정신력이 20% 감소하고, 물리 피격 시 HP를 소모한다.```");
    }
if (args ===`금흉갑`){
       message.channel.send("```asciidoc\n[금흉갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 95 순발력 7 사기 -\n효과 : 물리 공격과 해로운 책략을 방어할 확률이 20% 만큼 증가한다.```");
    }
if (args ===`사각문의`){
       message.channel.send("```asciidoc\n[사각문의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 7 방어력 66 순발력 - 사기 10\n효과 : 물리 공격과 해로운 책략을 방어할 확률이 20% 만큼 증가한다.```");
    }
if (args ===`상구`){
       message.channel.send("```asciidoc\n[상구] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 80 순발력 - 사기 -\n효과 : 물리 공격과 해로운 책략을 방어할 확률이 20% 만큼 증가한다.```");
    }
if (args ===`흑광갑옷`){
       message.channel.send("```asciidoc\n[흑광갑옷] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 95 순발력 - 사기 10\n효과 : 상태이상 중독을 100% 방어한다.```");
    }
if (args ===`파문의`){
       message.channel.send("```asciidoc\n[파문의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 68 순발력 - 사기 10\n효과 : 상태이상 중독을 100% 방어한다.```");
    }
...
if (args ===`구석`){
       message.channel.send("```asciidoc\n[구석] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 72 순발력 10 사기 10\n효과 : 책략 피격 시 피해의 20%를 공격자에게 되돌린다. 단, 사신 책략은 피해 반사하지 않음.```");
    }
if (args ===`팔기갑`){
       message.channel.send("```asciidoc\n[팔기갑] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 85 순발력 15 사기 -\n효과 : 공격 범위 내에 복수의 적군이 있을 때, 물리 피격 시 피해가 30% 감소하고, 감소한 피해를 HP가 낮은 적에게 전가한다.```");
    }
if (args ===`복두공복`){
       message.channel.send("```asciidoc\n[복두공복] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 60 순발력 - 사기 10\n효과 : 공격 범위 내에 복수의 적군이 있을 때, 물리 피격 시 피해가 30% 감소하고, 감소한 피해를 HP가 낮은 적에게 전가한다.```");
    }
if (args ===`현무전포`){
       message.channel.send("```asciidoc\n[현무전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 71 순발력 10 사기 20\n효과 : 공격 범위 내에 복수의 적군이 있을 때, 물리 피격 시 피해가 30% 감소하고, 감소한 피해를 HP가 낮은 적에게 전가한다.```");
    }
if (args ===`치우갑옷`){
       message.channel.send("```asciidoc\n[치우갑옷] 7★\n종류 : 갑옷\n능력 : 공격력 - 정신력 - 방어력 90 순발력 20 사기 -\n효과 : 상태이상 혼란을 100% 방어한다.```");
    }
if (args ===`수면문의`){
       message.channel.send("```asciidoc\n[수면문의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 - 방어력 68 순발력 - 사기 10\n효과 : 상태이상 혼란을 100% 방어한다.```");
    }
...
if (args ===`만독보도`){
       message.channel.send("```asciidoc\n[만독보도] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 90 방어력 - 순발력 - 사기 21\n효과 : 방해계 책략 사용 시 책략의 위력이 90% 만큼 증가한다. 단, 연속 책략이 발동하지 않는다.```");
    }
if (args ===`기린보도`){
       message.channel.send("```asciidoc\n[기린보도] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 90 방어력 7 순발력 - 사기 14\n효과 : 공격 책략 사용시 위력이 50%만큼 증가한다. 단, 연속 책략이 발동하지 않는다.```");
    }
if (args ===`황룡보도`){
       message.channel.send("```asciidoc\n[황룡보도] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 90 방어력 7 순발력 14 사기 -\n효과 : 공격 시 50% 만큼 추가 피해를 준다. 단, 연속 공격과 연속 반격이 발동하지 않는다.```");
    }
if (args ===`백룡 보검`){
       message.channel.send("```asciidoc\n[백룡 보검] 7★\n종류 : 보도\n능력 : 공격력 - 정신력 90 방어력 - 순발력 21 사기 -\n효과 : 공격 시 무조건 연속 공격을 가한다.```");
    }
if (args ===`자운금의`){
       message.channel.send("```asciidoc\n[자운금의] 7★\n종류 : 도포\n능력 : 공격력 - 정신력 15 방어력 75 순발력 - 사기 -\n효과 : 모든 책략에 대한 피해가 35% 만큼 감소한다. 단, 사신 책략은 피해 감소하지 않음.```");
    }
if (args ===`풍신 전포`){
       message.channel.send("```asciidoc\n[풍신 전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 - 방어력 80 순발력 14 사기 -\n효과 : 피해를 입을 경우 피해량의 50%를 본대의 주위 8칸(ZOC)에 존재하는 무작위 아군 1부대에게 전가한다.```");
    }
if (args ===`백운 전포`){
       message.channel.send("```asciidoc\n[백운 전포] 7★\n종류 : 전포\n능력 : 공격력 - 정신력 7 방어력 80 순발력 7 사기 -\n효과 : 모든 책략에 대한 피해가 35% 만큼 감소한다. 단, 사신 책략은 피해 감소하지 않음.```");
    }
if (args ===`상황내문`){
       message.channel.send("```asciidoc\n[상황내문] 7★\n종류 : 보조구\n능력 : 공격력 23 정신력 23 방어력 - 순발력 - 사기 -\n효과 : 매턴 장수의 상태이상이 회복된다.```");
    }
